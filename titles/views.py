...
from .serializers import TitleListSerializer, TitleCreateSerializer, GenreSerializer, CategorySerializer
from .permissions import IsAdminOrAuthor
from .filters import TitleFilter


class BaseCreateListDestroyViewSet(CreateModelMixin,
                                    ListModelMixin,
                                    DestroyModelMixin,
